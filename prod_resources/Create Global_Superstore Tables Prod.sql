...
GRANT SELECT, REFERENCES ON TABLE public.global_superstore TO prod_user;
...
GRANT SELECT, REFERENCES ON TABLE public.entitlements TO prod_user;
...
GRANT SELECT, REFERENCES ON TABLE public.webapp_users TO prod_user;